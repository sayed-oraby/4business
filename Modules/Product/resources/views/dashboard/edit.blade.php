...
@section('title', __('product::product.actions.edit'))
@section('page-title', __('product::product.actions.edit') . ' — ' . ($product->title ?? '#'.$product->id))
...
@section('toolbar-actions')
    ...
    @can('products.update')
        <button class="btn btn-primary" type="submit" form="productForm" data-product-submit data-kt-indicator="off">
            <span class="indicator-label">{{ __('product::product.form.submit_update') }}</span>
            <span class="indicator-progress">
                {{ __('product::product.form.submit_update') }}
