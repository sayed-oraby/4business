...
class StoreBlogRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        ...
        return [
            'title.required' => trans('blog::validation.title.required', [], $locale),
            'title.array' => trans('blog::validation.title.array', [], $locale),
            'title.en.required_without' => trans('blog::validation.title.en.required_without', [], $locale),
            'title.ar.required_without' => trans('blog::validation.title.ar.required_without', [], $locale),
            ...
            'status.required' => trans('blog::validation.status.required', [], $locale),
